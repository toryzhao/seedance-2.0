...
| 背景光 | bèijǐng guāng | Background light | `背景分离光` |
| 顶光 | dǐng guāng | Top light | `顶光俯照` |
...
| 节奏 | jiézòu | Rhythm / Pacing | `紧张节奏` / `舒缓节奏` |
...
| 中文 | 拼音 | English | Prompt use |
|---|---|---|---|
| 环境音 | huánjìng yīn | Ambient sound | `森林环境音` |
| 音效 | yīnxiào | Sound effects (SFX) | `冲击音效` |
...
| 音频同步 | yīnpín tóngbù | Audio sync | `口型同步` |
...
| 中文 | 拼音 | English | Prompt use |
|---|---|---|---|
| 粒子效果 | lìzǐ xiàoguǒ | Particle effects | `金色粒子飘散` |
| 爆炸特效 | bàozhà tèxiào | Explosion VFX | `爆炸冲击波` |
| 魔法效果 | mófǎ xiàoguǒ | Magic / Sorcery FX | `魔法光环绕手` |
| 光剑 | guāngjiàn | Energy blade / Lightsaber | `能量刃，蓝色光剑` |
| 变形 | biànxíng | Morph / Transform | `人物变形特效` |
| 消散 | xiāosàn | Dissolve / Disintegrate | `灰烬消散效果` |
| 时间停止 | shíjiān tíngzhǐ | Time freeze | `时间停止，子弹定格` |
| 全息投影 | quánxī tóuyǐng | Hologram | `全息投影界面` |
| 能量波 | néngliàng bō | Energy wave / Shockwave | `能量冲击波扩散` |
...
| 中文 | 拼音 | English | Prompt use |
|---|---|---|---|
| 出拳 | chū quán | Punch | `右拳直击` |
| 踢腿 | tī tuǐ | Kick | `旋风踢` |
| 格挡 | gédǎng | Block / Parry | `手臂格挡` |
| 闪避 | shǎnbì | Dodge / Evade | `侧身闪避` |
| 翻滚 | fāngǔn | Roll | `前滚翻` |
| 跳跃 | tiàoyuè | Jump / Leap | `纵身跃起` |
| 擒拿 | qínnà | Grapple / Grab | `抓腕制服` |
| 摔投 | shuāi tóu | Throw / Takedown | `过肩摔` |
| 武器格斗 | wǔqì gédòu | Weapon combat | `剑术对决` |
| 连击 | liánjī | Combo | `三连击` |
...
| 中文 | 拼音 | English | Prompt use |
|---|---|---|---|
| 快门速度 | kuàimén sùdù | Shutter speed | `高速快门，冻结动作` |
| 光圈 | guāngquān | Aperture | `大光圈，虚化背景` |
| ISO感光度 | ISO gǎnguāngdù | ISO sensitivity | `高ISO，暗场噪点质感` |
| 白平衡 | bái pínghéng | White balance | `暖白平衡` |
| 曝光补偿 | bàoguāng bǔcháng | Exposure compensation | `+1EV，明亮调` |
| 动态范围 | dòngtài fànwéi | Dynamic range | `高动态范围，HDR` |
| 色温 | sèwēn | Color temperature | `3200K 钨丝灯暖调` |
| 长曝光 | cháng bàoguāng | Long exposure | `长曝光，流光` |
| 高速摄影 | gāosù shèyǐng | High-speed photography | `高速摄影，水花定格` |
...
- Level 2: `[主角描述]，[动作]，[环境]`
- Level 3: `0–4秒[A]；4–8秒[B]；8秒后[C]`
- Level 4: `[角色A]对[角色B]，[连续动作序列]，[精确运镜]，[灯光]，[音效]`
